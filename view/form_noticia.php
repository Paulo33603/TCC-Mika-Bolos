            ...
            <div class="col-lg-12">
                ...
                <form action="<?php echo $acao;?>" method="post" role="form" enctype="multipart/form-data">						
                         <div class="form-group">
                            <label>Nome</label>
                            <input name="titulo" class="form-control" id="titulo" placeholder="Informe o título da notícia" required value="<?php echo $not->titulo;?>">                                           
                        </div>

                        <div class="form-group">
                            <label>Dscrição</label>
                            <input name="texto" class="form-control" id="texto" placeholder="Informe o texto" required value="<?php echo $not->texto;?>">                                           
                        </div>
                        ...
                        <input type="hidden" name="codnoticia" value="<?php echo $not->codnoticia;?>">
